...
A miscellany of Quantum Computing

## Platform scripts

I will post shell scripts in this repository for installing Qiskit on various platforms. These are often out of date and I am from time to time revisiting them.
...
No guarantees, of course! Such recipes tend to quickly go out of date. [Post an issue](https://github.com/jwoehr/Quantum-Computing/issues) if you find any problems or need any help, please!

## Other repos of mine concerning quantum computing

### Current repos

* [Quantum Yi Qing](https://github.com/jwoehr/quantum_yiqing)
  * Cast traditional oracle from quantum computer
* [gopenqasm3](https://github.com/jwoehr/gopenqasm3)
  * A Go parser for OpenQASM 3.0, generated from the official ANTLR grammar.

### Repos of possibly historical value
...
* [NuQASM2](https://github.com/jwoehr/nuqasm2) **Archived** _Out of date with respect to modern Qiskit_
  * Experimental regexp-based parser for OpenQASM 2
